    ...
    return (
      <div className="flex gap-2">
        <input
          ...
          className={`flex-1 px-4 py-2.5 border rounded-xl text-foreground bg-background border-input ${colors.inputFocus} focus:ring-2`}
        />
        <button
        ...
        <button
          ...
          className={`p-2.5 rounded-xl hover:bg-muted/50`}
        >
          <X size={16} />
        </button>
      </div>
        ...
        <DialogBody>
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-xl text-foreground bg-background border-input ${colors.inputFocus} focus:ring-2`}
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-3 pr-10 border rounded-xl text-foreground bg-background border-input ${colors.inputFocus} focus:ring-2`}
              />
              <button
                onClick={() => handleCopy(form.machineId, 'machineId')}
                className={`absolute right-3 top-1/2 -translate-y-1/2 p-1.5 rounded-lg hover:bg-muted/50`}
              ...
              <div>
                ...
                <div className="relative">
                  <textarea
                    ...
                    rows={2}
                    className={`w-full px-4 py-3 pr-10 border rounded-xl text-foreground bg-background border-input ${colors.inputFocus} focus:ring-2 resize-none`}
                  />
                  <button
                    onClick={() => handleCopy(form.clientSecret, 'clientSecret')}
                    className={`absolute right-3 top-3 p-1.5 rounded-lg hover:bg-muted/50`}
