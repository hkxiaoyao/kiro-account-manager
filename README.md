...
**最新版本 v1.8.6**（发布于 2026-05-10）：请前往 [Releases](https://github.com/hj01857655/kiro-account-manager/releases/latest)（自动保持最新）

> 以下下载链接可能滞后，以 Releases 为准。

| 平台 | 架构 | 文件格式 | 下载链接 |
|------|------|---------|---------|
| 🪟 **Windows** | x64 | MSI 安装包 | [KiroAccountManager_1.8.6_x64_zh-CN.msi](https://github.com/hj01857655/kiro-account-manager/releases/download/v1.8.6/KiroAccountManager_1.8.6_x64_zh-CN.msi) |
| 🍎 **macOS** | Intel (x64) | DMG 镜像 | [KiroAccountManager_1.8.6_x64.dmg](https://github.com/hj01857655/kiro-account-manager/releases/download/v1.8.6/KiroAccountManager_1.8.6_x64.dmg) |
| 🍎 **macOS** | Apple Silicon (M1/M2/M3) | DMG 镜像 | [KiroAccountManager_1.8.6_aarch64.dmg](https://github.com/hj01857655/kiro-account-manager/releases/download/v1.8.6/KiroAccountManager_1.8.6_aarch64.dmg) |
| 🐧 **Linux** | x86_64 | AppImage | [KiroAccountManager_1.8.6_amd64.AppImage](https://github.com/hj01857655/kiro-account-manager/releases/download/v1.8.6/KiroAccountManager_1.8.6_amd64.AppImage) |
| 🐧 **Linux** | x86_64 | DEB 包 | [KiroAccountManager_1.8.6_amd64.deb](https://github.com/hj01857655/kiro-account-manager/releases/download/v1.8.6/KiroAccountManager_1.8.6_amd64.deb) |
...
### 🌐 Kiro API 网关
内置 OpenAI 兼容网关，支持 Claude Code / Codex / Cursor / Continue / Cline 等第三方工具直接接入。
- 兼容 Anthropic `/v1/messages`、OpenAI `/v1/responses`、`/v1/chat/completions`
- 多账号负载均衡（轮询 / 最少连接 / 加权），配额满自动禁用切换
- 一键配置客户端（Claude Code / Codex CLI），自动写入反代地址
- Prompt Caching、Token 估算、请求日志、实时观测面板
- 账号启用/禁用开关，超额账号智能判断（不误切开启超额的 Pro 账号）
- API Key 鉴权、IP 白名单、仅本机/远程访问控制
...
> **💡 急着用最新修复？** 日常 bug 修复和功能优化会持续提交到 `public` 分支，不会每个修复都发版本。急着用的话直接拉代码自己编译，不用等发版。
...
<p align="center"><sub>最后更新：2026-05-10 | 版本：v1.8.6</sub></p>
